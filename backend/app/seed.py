...
SEED_MODELS = [
    ...
    # ============================================================
    {"slug": "claude-cli", "provider": "cli_subshell", "model_id": "claude-cli",
    ...
    # ============================================================
    {"slug": "codex-cli-gpt-5", "provider": "cli_subshell", "model_id": "codex-cli-gpt-5",
     "display_name": "Codex CLI – GPT-5 Codex (requires `codex` on PATH)",
     "params": _cli_params("codex", "gpt-5-codex")},
    {"slug": "cursor-agent", "provider": "cli_subshell", "model_id": "cursor-agent",
     ...
     "params": {"cli": "cursor-agent", "extra_args": ["--print"],
                ...
                "dangerous_skip_permissions": False}},
    {"slug": "gemini-cli", "provider": "cli_subshell", "model_id": "gemini-cli",
     "display_name": "Gemini CLI – `gemini` (requires Google CLI on PATH)",
     "params": _cli_params("gemini")},
    {"slug": "github-copilot-cli", "provider": "cli_subshell", "model_id": "github-copilot-cli",
     ...
     "params": {"cli": "gh", "extra_args": ["copilot", "suggest"],
                ...
                "dangerous_skip_permissions": False}},
    {"slug": "amp-cli", "provider": "cli_subshell", "model_id": "amp-cli",
     "display_name": "Sourcegraph Amp CLI – `amp` (requires Amp on PATH)",
     "params": _cli_params("amp")},
    {"slug": "aider-cli", "provider": "cli_subshell", "model_id": "aider-cli",
